...
@if(Auth::check())
    ...
    <div class="col-lg-12 no-print">         
        <h2 class="content-heading">ADMINISTRACION - VISTA DE CLIENTE</h2>
    </div>
    <div class="container-fluid">
            <!-- Dynamic Table Full -->
            <div class="block">
            	<div class="block-header block-header-default no-print">
                    <h3 class="block-title"><i class="fa fa-shopping-cart" aria-hidden="true"></i>&nbsp;&nbsp;Tabla de Datos del <small>Cliente</small></h3>
                    <a href="{{ url('cliente') }}">
                ...
                <div class="col-lg-12 text-uppercase">
                    <center><span><h2 class="block-title" style="text-decoration: underline;">Datos del cliente<br></h2></span></center>
                </div>
                <br>
                <div class="col-lg-12">
                    <div class="form-row">
                    	<div class="form-group col-md-12 text-capitalize">
                    		<div class="form-row">
					            ...
					            @endforeach	
					                ...
					                <div class="form-group col-md-4">
					                		<strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$cliente->tipo_documento}}</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;{{$cliente->num_documento}}
					                </div>
					                <div class="form-group col-md-4">
					                ...
					                <div class="form-group col-md-4">
					                		<strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Expedido&nbsp;:&nbsp;{{$cliente->expedito}}</strong>
					                </div>
