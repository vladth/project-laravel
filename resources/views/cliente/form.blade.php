@if(Auth::check())
    ...
    <div class="form-group row {{$errors->has('nombre') ? 'has-error' : ''}}">
                ...
                <div class="col-md-9">
                    <input type="text" id="nombre" value="{{ old('nombre') }}" name="nombre" class="form-control" placeholder="Ingrese el Nombre" required  pattern="^[a-zA-Z_áéíóúñ°\s]*{0,100}$" title="Solo se acepta letras y maximo 100 caracteres">
    ...
    <div class="form-group row">
                ...
                <div class="col-md-9">
                    <input type="text" id="direccion" value="{{ old('direccion') }}" name="direccion" class="form-control" placeholder="Ingrese la dirección" required pattern="^[a-zA-Z0-9_áéíóúñ°\s]*{0,200}$" title="Solo se acepta 70 caracteres">
                    <div class="text-danger">
    ...
    <div class="form-group row">
            <label class="col-md-3 form-control-label" for="expedito">Expedito</label>
    ...
    <div class="form-group row">
                ...
                <div class="col-md-9">
                    ...
                    <input type="text" id="telefono" value="{{ old('telefono') }}" name="telefono" class="form-control" placeholder="Ingrese el telefono" required pattern="^[0-9\s]{0,200}$" title="Solo se acepta números y un maximo de 20 caracteres">
                    <div class="text-danger">
    ...
    <div class="form-group row">
                ...
                <input type="email" class="form-control" value="{{ old('email') }}" id="email" name="email"  placeholder="Ingrese el correo" required>
                <div class="text-danger">
