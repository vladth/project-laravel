...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $totalu = DB::select('SELECT COUNT(*) as total from users u where u.condicion = 1');

        return view('home', ['comprasmes' => $comprasmes, 'ventasmes' => $ventasmes, 'ventasdia' => $ventasdia, 'productosvendidos' => $productosvendidos, 'totales' => $totales, 'totalu' => $totalu]);
