...
class ProveedorUpdateRequest extends FormRequest
{
    ...
    {
        return [
            'nombre' => 'required|min:2|max:100|unique:proveedores,nombre,'.$this->id_proveedor,
            'tipo_documento' => 'required|in:NIT,CI',
            'num_documento' => 'required|numeric|unique:proveedores,num_documento,'.$this->id_proveedor, 
