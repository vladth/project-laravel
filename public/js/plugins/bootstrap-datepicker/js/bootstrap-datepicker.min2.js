...
! function(a) {
        ...
        fillDow: function() {
            if (this.o.showWeekDays) {
                var b = this.o.weekStart,
                    c = "";
                for (this.o.calendarWeeks && (c += ' '); b < this.o.weekStart + 7;) c += '";
                c += "", this.picker.find(".datepicker-days thead").append(c)
            }
        },
        fillMonths: function() {
            for (var a, b = this._utc_to_local(this.viewDate), c = "", d = 0; d < 12; d++) a = b && b.getMonth() === d ? " focused" : "", c += '' + q[this.o.language].monthsShort[d] + "";
            ...
            if (!isNaN(h) && !isNaN(i)) {
                ...
                for (var x, y, z = []; u.valueOf() < w;) {
                    ...
                    this.o.beforeShowDay !== a.noop && (f = this.o.beforeShowDay(this._utc_to_local(u)), f === b ? f = {} : "boolean" == typeof f ? f = {
                        ...
                        classes: f
                    }), !1 === f.enabled && y.push("disabled"), f.classes && (y = y.concat(f.classes.split(/\s+/))), f.tooltip && (e = f.tooltip), f.content && (E = f.content)), y = a.isFunction(a.uniqueSort) ? a.uniqueSort(y) : a.unique(y), z.push('' + E + ""), e = null, x === this.o.weekEnd && z.push(""), u.setUTCDate(u.getUTCDate() + 1)
                }
    ...
    var q = a.fn.datepicker.dates = {
            en: {
                ...
                daysShort: ["Dom", "Lun", "Mar", "Mier", "Ju", "Vi", "Sa"],
        ...
        r = {
            ...
            headTemplate: '' + o.templates.leftArrow + '' + o.templates.rightArrow + "",
            contTemplate: '',
            footTemplate: ''
        };
    r.template = '' + r.headTemplate + "" + r.footTemplate + '' + r.headTemplate + r.contTemplate + r.footTemplate + '
' + r.headTemplate + r.contTemplate + r.footTemplate + '
' + r.headTemplate + r.contTemplate + r.footTemplate + '
' + r.headTemplate + r.contTemplate + r.footTemplate + "", a.fn.datepicker.DPGlobal = r, a.fn.datepicker.noConflict = function() {
